     ...
     <div className="w-full md:w-1/2 md:pr-4">
        ...
        <form className="content-center" onSubmit={handleSubmit}>
          ...
          <Button
            ...
            message="Dapatkan Token Update"
            disabled={loading}
          />
        </form>
        <div className="flex justify-center items-center mb-2 pt-2">
                    <div className="w-16 h-px bg-gray-300"></div>
                    <div className="mx-4 text-gray-700 text-sm text-center">
                        <p>Sudah mendapatkan token ?</p>
                    </div>
                    <div className="w-16 h-px bg-gray-300"></div>
                </div>
        <Button
            type="button"
            variant="border border-maintheme text-maintheme w-full hover:bg-pink-200"
            message="Perbarui Password Disini"
